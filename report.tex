...
through practice. In effect, the _Fundamento_ can be considered as the
...
non-sequitur (perhaps Chomsky implicitly believes that _real_ languages
develop _de novo_ without any interlinguistic interaction to speak of).
...
\url\url{http://beta.visl.sdu.dk/visl/eo/index.php EspGram} constraint 
...
\begin{itemize}
\item Goodman reduction: \url{https://unstable.nl/andreas/dopg.py own implementation}, using 
\url{http://groups.google.com/group/nltk-dev/browse_thread/thread/86ca038723195978/c112b8d171b33d25 NLTK}. 
maybe add backoff DOP or DOP*; fast PCFG parsing using 
\url{http://www.ims.uni-stuttgart.de/tcl/SOFTWARE/BitPar.html bitpar} 
...
\begin{itemize}
\item \url{http://staff.science.uva.nl/~simaan/dopdis/ dopdis} (C): already has Goodman reduction and DOP*;
\item \url{http://sourceforge.net/projects/lilian/ lilian} (Java): has Goodman reduction, no DOP*; also has U-DOP.
\item Gideon Borensztajn's \url{http://staff.science.uva.nl/~gideon/sourcecode/DOPParser.tar.gz DOPParser} (Java): has Goodman reduction
\end{itemize}
...
http://www.sunflower.com/~miner/NEGATIVA_package/negativa.html
