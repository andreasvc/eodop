...
\item syntax: Monato treebank (Bick, personal communication, a corpus parsed
      ...
      also, unique POS tags are inserted for punctuation; about 1500 trees remain.
\end{itemize}
...
A two-level Hidden Markov Model (HMM) for assigning tags to unknown words and
morphemes. The results can be added to the lexicon, after which Bitpar can be
reloaded.
