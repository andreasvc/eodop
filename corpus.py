...
(S (NP (NP (DT la) (N' (JJ konata) (NN amiko))) (NPC (CC aŭ) (NP (NP (DT la) (NNS amiko)) (S (NP (DT kiun)) (VP (NP (PRP oni)) (VP (VBD atendis))))))))
...
(S (NP (DT (DT tiu) (RB ĉi)) (NN ĝardeno)) (VP (VB estas) (NP (NP (JJ amata) (NN loko)) (PP (IN de) (NN birdoj)))) )
...
(S (NP (PRP ĝi)) (VP (VB estas) (VP (VB uzata) (NP (DT tian) (S (NP (DT kian)) (VP (NP (PRP ni)) (VP (VB parolas) (PP (IN pri) (N' (NN objektoj) (JJ konataj))))))))) )
(S (PP (IN anstataŭ) (NP (NN "la"))) (S (NP (PRP oni)) (VP (VP (VB povas) (RB ankaŭ)) (VP (VP (VB diri) (NP (NN "l'"))) (PP (IN se) (S (NP (PRP ĝi)) (VP (RB ne) (VP (VB estos) (RB malbonsone)))))))) )
(S (S (PP (IN se) (S (NP (DT iu)) (VP (VP (VP (RB ne) (VB komprenas)) (RB bone)) (NP (NP (DT la) (NN uzon)) (PP (IN de) (NP (DT la) (NN artikulo))))))) (S (NP (PRP li)) (VP (VP (VB povas) (RB tute)) (VP (NP (PRP ĝin)) (VP (RB ne) (VB uzi)))))) (SC (CC ĉar) (S (NP (PRP ĝi)) (VP (VB estas) (NP (NP (JJ oportuna)) (NPC (CC sed) (NP (RB ne) (JJ necesa))))))))""".splitlines()
